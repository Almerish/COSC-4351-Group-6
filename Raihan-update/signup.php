  ...
  <body>
	...
	<div class="container-fluid">
	  <div class="container">
        ...
        <h2 class="text-center" >Best Restaurent in Houston Area</h2>
		 <form action = "reservation.php" method="POST">
		  	<center>
			<input type ="text" name="username" placeholder="Full name" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>"> <br>
            <span class="invalid-feedback"><?php echo $username_err; ?></span>

		  	<input type ="text" name="email" placeholder="Email" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?>"><br>
            <span class="invalid-feedback"><?php echo $email_err; ?></span>

			<input type ="text" name="mailing_address" placeholder="Mailing Address" class="form-control <?php echo (!empty($mailing_address_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $mailing_address; ?>"><br>
            <span class="invalid-feedback"><?php echo $mailing_address_err; ?></span>

			<input type ="text" name="billing_address" placeholder="Billing Address" class="form-control <?php echo (!empty($billing_address_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $billing_address; ?>"><br>
            <span class="invalid-feedback"><?php echo $billing_address_err; ?></span>            

			<input type ="password" name="password" placeholder="Password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>"><br>
            <span class="invalid-feedback"><?php echo $password_err; ?></span>            

			<input type ="password" name="confirm_password" placeholder="Repeat Password" class="form-control <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_password; ?>"><br>
            <span class="invalid-feedback"><?php echo $confirm_password_err; ?></span>
			
            <a input type = "submit" button type="submit" name="submit" class="btn btn-primary" value ="Submit" href = "index.php">Submit</a></button>
            <input type ="reset" button type="reset" name="reset" value ="Reset" class="btn btn-secondary ml-2"></button>
